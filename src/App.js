class Spinner {
  ...
  create() {
    const logoElm = this.settings.type === 'logo' ? `<div class="anim-bounce"><div class="anim2">
    ...
    const loaderElm = this.settings.type === 'loader' ? `<div class="anim3" style="color: ${this.settings.loaderColor};"></div>` : ``;
    const percentElm = this.settings.type === 'percent' ? `<div class="prog" style="color: ${this.settings.percentColor};"></div>` : ``;

    let spinnerElm = document.createElement("div");

    spinnerElm.innerHTML = `
    <div class="animation">
      <div class="anim1" style="border-color: ${this.settings.spinnerColor};">
      </div>
      ${logoElm}
      ${percentElm}
      ${loaderElm}
